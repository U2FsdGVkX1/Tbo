...
class Backup extends Base {
    public function command ($command, $param, $message_id, $from, $chat, $date) {
        if ($command == '/backup') {
            ...
            $backupFile = $this->EXPORT_TABLES(DBHOST, DBUSER, DBPASS, DBNAME);
    ...
    function EXPORT_TABLES($host, $user, $pass, $name, $tables = false)
    {
        ...
        $backup_name = $savePath . $name . "_(" . date('Y-m-d_H-i-s') . ")_rand" . rand(1, 11111111) . ".sql.gz";
